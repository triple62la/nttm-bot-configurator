...
def init_nttm_url(root):
    ...
    url = StringVar(frame, value='http://www.ttm.rt.ru')
    ...
    other_btn = Radiobutton(frame, text="Другое", value="http://", variable=url, command=other_input_enable)
